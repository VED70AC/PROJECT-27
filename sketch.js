...
function keyPressed(){
	if(keyCode == UP_ARROW){
		...
		Matter.Body.applyForce(bob2.body,bob2.body.position,{x: -300,y:-300})
		Matter.Body.applyForce(bob3.body,bob3.body.position,{x: -300,y:-300})
		Matter.Body.applyForce(bob4.body,bob4.body.position,{x: 300,y:300})
